...
import { jsx } from 'vue/jsx-runtime';
  ...
  const addTodo = () =>{
    if(input_content.value.trim() === '' || input_category.value == null){  //using a conditional statement to check if the box is empty
      return 
    }

    myArray.value.push({ //pushing content to the array 
